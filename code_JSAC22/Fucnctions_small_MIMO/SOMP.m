function [H_hat, A_UE_index,A_seq_index, iter_num] = SOMP(Y, Phi, Pn,K,N_seq)
...
H_hat(supp_set,:,:) = H_ls;
% 实际利用了结构性
A_seq_index=zeros(K*N_seq,1);
A_seq_index(supp_set)=1;
Ind_temp=reshape(A_seq_index,[N_seq,K]);
